...
class Training:
    ...
    def show_training_info(self) -> InfoMessage:
        ...
        info_Mess = InfoMessage(type(self).__name__,
                                self.duration,
                                self.get_distance(),
                                self.get_mean_speed(),
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        speed_in_ms: float = self.get_mean_speed() * self.KMpH_IN_MpSEC
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    raise KeyError(f'{workout_type} - неизввестный вид тренировки')
